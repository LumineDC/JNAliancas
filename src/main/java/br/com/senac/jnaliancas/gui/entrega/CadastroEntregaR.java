...
public class CadastroEntregaR extends javax.swing.JFrame {

    private JFrame telaAnterior;  
    
    public CadastroEntregaR(JFrame telaAnterior) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Prazo/data de retirada");

        txtPrazo.setBackground(new java.awt.Color(153, 153, 153));
        txtPrazo.setText("                    dd/mm/aaaa");
        txtPrazo.setToolTipText("Insira a data");
        ...
        btnVendas.getAccessibleContext().setAccessibleDescription("Botão para salvar");
        ...
        txtPrazo.getAccessibleContext().setAccessibleName("Data");
        txtPrazo.getAccessibleContext().setAccessibleDescription("Campo para inserção de data");
    ...
    private void btnVendasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVendasActionPerformed
        ...
        else if (!validarData(txtPrazo.getText().trim())) {
            JOptionPane.showMessageDialog(null, "Prazo inválido! Insira no formato: dd/mm/aaaa");
        }
        
        else {
            
            String tipo = "Retirar no local";
            Float frete = 0f;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroEntregaR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

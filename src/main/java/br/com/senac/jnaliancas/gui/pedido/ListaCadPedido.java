...
public class ListaCadPedido extends javax.swing.JFrame {

    private JFrame telaAnterior;
    PedidoDAO pd = new PedidoDAO();
    DateTimeFormatter formato = DateTimeFormatter.ofPattern("dd/MM/yyyy");
    
    public ListaCadPedido(JFrame telaAnterior) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblPedidos.setBackground(new java.awt.Color(176, 176, 176));
        ...
        tblPedidos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Produto", "Cliente", "Quantidade", "Data", "Observações", "Concluído"
            }
        ) {
        ...
        tblPedidos.setToolTipText("Tabela de Pedidos");
        jScrollPane1.setViewportView(tblPedidos);
        tblPedidos.getAccessibleContext().setAccessibleName("Tabela de Pedidos");
        ...
        btnAlterar.setToolTipText("Clique alterar dado de pedido");
        ...
        btnRemover.setToolTipText("Clique abrir para remover pedido");
        ...
        btnAlterar.getAccessibleContext().setAccessibleDescription("Botão para alterar dado de pedido");
        btnRemover.getAccessibleContext().setAccessibleDescription("Botão para remoção de pedido");
    ...
    void preencheTabela(List<Pedido> lp) {
        String colunas[] = {"Id", "Produto", "Cliente", "Quantidade", "Data", "Observações", "Concluido"};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaCadPedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

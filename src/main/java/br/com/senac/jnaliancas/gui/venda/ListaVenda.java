 ...
 */
package br.com.senac.jnaliancas.gui.venda;
...
public class ListaVenda extends javax.swing.JFrame {
    ...
    public ListaVenda(JFrame telaAnterior) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblVendas.setBackground(new java.awt.Color(176, 176, 176));
        ...
        tblVendas.setToolTipText("Tabela de Vendas");
        jScrollPane1.setViewportView(tblVendas);
        tblVendas.getAccessibleContext().setAccessibleName("Tabela de Vendas");
        ...
        btnRemover.setToolTipText("Clique abrir para remover venda");
        ...
        btnRemover.getAccessibleContext().setAccessibleDescription("Botão para remoção de venda");
    ...
    void preencheTabela(List<Pedido> lp) {
        String colunas[] = {"Cliente", "Data", "Valor", "Produto"};
        ...
        for (Pedido p : lp) {
            dados[i] = new String[]{
                ...
                String.valueOf(p.getProduto().getPreco()),
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        try {
            if (tblVendas.getSelectedRow() >= 0) {
                String id = (String) tblVendas.getValueAt(tblVendas.getSelectedRow(), 0);

 ...
 * @author user
 */
public class ListaCadCliente extends javax.swing.JFrame {

    private JFrame telaAnterior;
    ClienteDAO cd = new ClienteDAO();
    
    public ListaCadCliente() {
        initComponents();
    }
    
    public ListaCadCliente(JFrame telaAnterior) {
        initComponents();
        this.telaAnterior = telaAnterior;
        preencheTabela(cd.listar());
    }
    ...
    private void initComponents() {
        ...
        tblClientes.setBackground(new java.awt.Color(176, 176, 176));
        ...
        tblClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Idade", "CPF", "Telefone", "Endereço"
            }
        ) {
        ...
        tblClientes.setToolTipText("Tabela de Clientes");
        jScrollPane1.setViewportView(tblClientes);
        tblClientes.getAccessibleContext().setAccessibleName("Tabela de Clientes");
        ...
        btnAlterar.setToolTipText("Clique alterar dado de cliente");
        ...
        btnRemover.setToolTipText("Clique abrir para remover cliente");
        ...
        btnAlterar.getAccessibleContext().setAccessibleDescription("Botão para alterar dado de cliente");
        btnRemover.getAccessibleContext().setAccessibleDescription("Botão para remoção de cliente");
    ...
    void preencheTabela(List<Cliente> lc) {
        String colunas[] = {"Id", "Nome", "Idade", "CPF", "Telefone", "Endereço"};
        String dados[][] = new String[lc.size()][colunas.length];
        ...
        for (Cliente c : lc) {
            dados[i] = new String[]{
                ...
                c.getCpf(),
                c.getTelefone(),
                "Rua " +  c.getRua() + ", nº" + c.getNumero() + ", " + c.getComplemento() + ", bairro " + c.getBairro() + ", " +  c.getCidade() + ", " + c.getEstado() + ", " + c.getCep()
            };
            i++;
        }
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            CadastroClientes cc = new CadastroClientes(this);

            if (tblClientes.getSelectedRow() >= 0) {
                String id = (String) tblClientes.getValueAt(tblClientes.getSelectedRow(), 0);
                ClienteDAO cd = new ClienteDAO();
                Cliente cSelecionado = cd.obter(Integer.parseInt(id));
                cc.preencheEdicao(cSelecionado);
                cc.setVisible(true);
            }
        } catch (Exception e) {
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        try {
            if (tblClientes.getSelectedRow() >= 0) {
                ...
                {
                    ClienteDAO cd = new ClienteDAO();
                    cd.excluir(Integer.parseInt(id));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaCadCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
